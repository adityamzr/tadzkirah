...
export default function NotFound() {
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center px-5 text-center">
      ...
      <h1 className="mt-4 text-[22px] font-semibold">Konten tidak ditemukan</h1>
      <p className="mt-2 text-[14px] text-muted-foreground">
        Pengingat ini mungkin telah dipindahkan atau dihapus. Coba cari lagi dengan kata kunci lain.
      </p>
      <Link href="/" className="mt-6 rounded-full bg-[#171717] px-5 py-2 text-[13px] text-white dark:bg-white dark:text-black">
        Kembali ke Tadzkirah
      </Link>
    </div>
  )
}
